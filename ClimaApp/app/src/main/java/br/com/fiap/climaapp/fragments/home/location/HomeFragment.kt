...
import br.com.fiap.climaapp.R
import br.com.fiap.climaapp.data.CurrentLocation
import br.com.fiap.climaapp.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun setObservers() {
        with(homeViewModel) {
            currentLocation.observe(viewLifecycleOwner) { event ->
                val currentLocationDataState = event.getContentIfNotHandled() ?: return@observe
            ...
            weatherData.observe(viewLifecycleOwner) { event ->
                val weatherDataState = event.getContentIfNotHandled() ?: return@observe
    ...
    private fun startListeningManualLocationSelection() {
        requireActivity().supportFragmentManager.setFragmentResultListener(REQUEST_KEY_MANUAL_LOCATION_SEARCH) { _, bundle ->
    ...
    private fun stopListeningManualLocationSelection() {
        requireActivity().supportFragmentManager.clearFragmentResultListener(REQUEST_KEY_MANUAL_LOCATION_SEARCH)
    }
